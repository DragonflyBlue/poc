package com.nationwide.thermal_poc;
...
public class MainActivity extends FlutterActivity {
    ...
    private static final String CHANNEL = "com.nationwide.thermal_poc/flir";
    ...
    private void setListeners() {
        ...
        if(call.method.equals("sdkVersion")) {
            channel.invokeMethod("sdkVersionReturn", cameraHandler.sdkVersion());
        }
